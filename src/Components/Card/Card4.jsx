            ...
            {cards.map((card, index) => (
                <div key={index} className="container card mb-3">
                    ...
                    <div className="card-body">
                        ...
                        <div id="columnas" className="container card-text text-secondary mb-4">
                            ...
                            <p className="card-text text-secondary mt-3 mb-4">{card.texto4}</p>
                            <p className="card-text text-secondary mt-3 mb-4">{card.texto5}</p>


                        </div>
                        <div className="container d-flex">
                            <Link addToCart={addToCart} className="btn btn-primary w-40" >Añadir al cesta</Link>
                        </div>
                    </div>
                </div>
            ))}
